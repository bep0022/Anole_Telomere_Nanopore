...
#SBATCH --job-name=Guppy1_SB           # job name
...
#SBATCH --output=job-%j_Guppy1.out          # Output file. %j is replaced with job ID
#SBATCH --error=job-%j_Guppy1.err           # Error file. %j is replaced with job ID
