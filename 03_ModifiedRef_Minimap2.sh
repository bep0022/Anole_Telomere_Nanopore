...
#############################################################
#SBATCH --job-name=ModifiedRef_Minimap2_Test4           # job name
...
#SBATCH --output=job-%j_ModifiedRef_Minimap2_Test4.out          # Output file. %j is replaced with job ID
#SBATCH --error=job-%j_ModifiedRef_Minimap2_Test4.err           # Error file. %j is replaced with job ID
